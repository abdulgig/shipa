...
$outcalls= "SELECT * FROM countries WHERE phonecode IN (1,973,20,98,964,972,962,965,961,968,970,974,966,963,90,971,967,44)";
...
<div class="wrapper">
	...
	<table id="example" class="table table-striped table-bordered" style="width:100%">
		...
		$countcountry= "SELECT COUNT(country) AS countrycount FROM outcalls AS ot WHERE country='".$row['phonecode']."' ";
